...
const ScoringEngine = {
    ...
    evaluate_top_bottom_card(cardInput, boardObject, currentTree) {
        ...
        if (cardId === 'moss') {
            ...
            return {
                points: active ? this.topBottomCasesVp.moss : 0,
                calculated: true,
                detail: active
        ...
        if (cardId === 'wild_strawberries') {
            ...
            return {
                points: active ? this.topBottomCasesVp.wild_strawberries : 0,
                calculated: true,
                detail: active
        ...
        if (cardId === 'tree_ferns' || cardId === 'tree_fern') {
            ...
            const points = reptileCount * this.topBottomCasesVp.tree_ferns;
            return {
                points,
                calculated: true,
